...
public class Persona {
    ...
    public String toString() {
        return "{" + "Nombre Completo: " + NombreCompleto + "\n" + "ID: " + numId + "\n" + "Fecha de Nacimiento: " + fechaDeNacimiento + "\n" + "Dirección: " + direccion + ", " + direccion2 + "\n" + "Teléfono" + telefono + "\n" + "Tipo de Teléfono" + tipoTelefono + ", telefono2=" + telefono2 + ", tipoTelefono2=" + tipoTelefono2 + ", telefono3=" + telefono3 + ", tipoTelefono3=" + tipoTelefono3 +", tipo=" + tipo + '}';
    }
}
